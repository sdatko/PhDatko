...
\def\TheTitleEN{Title.}
\def\TheTitlePL{Tytuł.}

\def\TheAuthorLabel{Author}
% \def\TheAuthorTitle{mgr inż.}
\def\TheAuthorTitle{MSc Eng}
\def\TheAuthorName{Name Surname}

\def\TheSupervisorLabel{Supervisor}
% \def\TheSupervisorTitle{dr hab. inż.}
\def\TheSupervisorTitle{Prof PhD Eng}
\def\TheSupervisorName{Name Surname}

\def\TheDate{City, Year}

\def\TheSentenceText{Inspiring quote.}
\def\TheSentenceAuthor{Author}
...
\begin{document}
    ...
    \include{00c-abstract}
    \cleardoublepage

    \include{00d-streszczenie}
    \cleardoublepage

    \include{00e-acknowledgments}
    \cleardoublepage
